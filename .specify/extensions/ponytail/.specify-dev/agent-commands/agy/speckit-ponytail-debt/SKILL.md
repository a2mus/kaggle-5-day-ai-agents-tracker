---
name: speckit-ponytail-debt
description: 'Harvest every ponytail: comment into a debt ledger so deferred shortcuts
  get tracked'
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: ponytail:commands/speckit.ponytail.debt.md
---
