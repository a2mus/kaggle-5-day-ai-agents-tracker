---
name: speckit-ponytail-audit
description: 'Whole-repo audit for over-engineering: ranked list of what to cut, simplify,
  or replace'
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: ponytail:commands/speckit.ponytail.audit.md
---
